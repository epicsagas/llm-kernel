...
| `tokens` | Оценка токенов с эвристикой Unicode-скриптов | |
| `install` | Мастер установки AI-инструментов | |
| `search` | Гибридный поиск с Reciprocal Rank Fusion | |
| `embedding` | Типаж провайдера эмбеддингов + косинусное сходство | |
...
| `safety` | Маскирование секретов, классификация ошибок, санитизация вывода | |
...
| Флаги функций | ✅ 20 независимых модулей | Монолитная | Монолитная |
